...
<a href="https://2021.metaprojection.ca" target="_blank" rel="noopener">MetaProjection</a> aggregates Canadian federal electoral projections so visitors can see how the election is shaping up, both nationally and by district. A map at the top of the page shows how each electoral district is likely to vote. The site uses the visitor's geolocation to find their district and surface its likely winner.
